...
static void McpsIndication( McpsIndication_t *mcpsIndication ){
	...
	switch( mcpsIndication->McpsIndication )
	{
		...
		{
			/*
			printf( "MCPS_CONFIRMED - confirmet packet received ");

			Serial.println("\n\n****************************************************************************************");
			Serial.println("****************************************************************************************");
			Serial.println("****************************************************************************************");
			Serial.println("Estou em McpsIndication::MCPS_CONFIRMED e alguem mandou enviar algo com deviceState = " + String(deviceState));
			Serial.println("****************************************************************************************");
			Serial.println("****************************************************************************************");
			Serial.println("****************************************************************************************\n\n");
			*/
...
static void MlmeIndication( MlmeIndication_t *mlmeIndication ){
	switch( mlmeIndication->MlmeIndication )
	{
		...
		{// The MAC signals that we shall provide an uplink as soon as possible
			...
			Serial.println("****************************************************************************************");
			Serial.println("****************************************************************************************");
			Serial.println("Estou em MlmeIndication e alguem mandou enviar algo com deviceState = " + String(deviceState));
			Serial.println("****************************************************************************************");
			Serial.println("****************************************************************************************");
			Serial.println("****************************************************************************************\n\n");
			*/
...
void LoRaWanClass::cycle(uint32_t dutyCycle){
	...
	//printf("Em ::cycle, chamei OnTxNextPacketTimerEvent\n");
	OnTxNextPacketTimerEvent();

	//printf("Em ::cycle, vou dar start no timer\n");
